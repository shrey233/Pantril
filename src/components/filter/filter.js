  ...
  return (
    ...
    <div className={styles.filterSection}>
      <Modal isOpen={isModalOpen} toggle={toggle}>
        ...
        <div className="row justify-content-right md-5 pb-2">
    <div className="col-md-12 text-center heading-section " >
      <h3 className = {styles.header2}>Create your allergen-free shopping lists</h3>
    </div>
  </div>
      <Button
      ...
      <Collapse className={styles.avoidance} isOpen={true}>
        <ButtonGroup className={styles.filterButton}>
      ...
      <div className={styles.chooseStore}>
        <UncontrolledDropdown>
          ...
          <DropdownMenu  >
            <DropdownItem onClick={() => setStore("Woolworths")}>
              Woolworths
            </DropdownItem>
          </DropdownMenu>
        </UncontrolledDropdown>
...
<Button className ="justify-content-right"
color = 'light'
outline
